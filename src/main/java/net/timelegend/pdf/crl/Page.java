...
public class Page {
	...
	public void addText(int leftPosition, int topPositionFromBottom, String text, String transformation) {
		addText(leftPosition, topPositionFromBottom, mFontSize, text, transformation);
	}
	...
	public void addTextAsHex(int leftPosition, int topPositionFromBottom, String hex, String transformation) {
		addTextAsHex(leftPosition, topPositionFromBottom, mFontSize, hex, transformation);
	}
    ...
    private int checkFontSize(int fontSize) {
        if (mFontSize == 0) {
            if (fontSize > 0)
                mFontSize = fontSize;
            else {
                fontSize = mFontSize = 12;
            }
        }
        else if (fontSize == 0)
            fontSize = mFontSize;
