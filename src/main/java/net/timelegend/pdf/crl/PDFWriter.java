...
public class PDFWriter {
    ...
    public void setFontSize(int fontSize) {
        mCurrentPage.setFontSize(fontSize);
    }
	...
	public void addText(int leftPosition, int topPositionFromBottom, String text) {
		addText(leftPosition, topPositionFromBottom, text, Transformation.DEGREES_0_ROTATION);
	}

	public void addText(int leftPosition, int topPositionFromBottom, String text, String transformation) {
		mCurrentPage.addText(leftPosition, topPositionFromBottom, text, transformation);
	}
	...
	public void addTextAsHex(int leftPosition, int topPositionFromBottom, String hex) {
		addTextAsHex(leftPosition, topPositionFromBottom, hex, Transformation.DEGREES_0_ROTATION);
	}

	public void addTextAsHex(int leftPosition, int topPositionFromBottom, String hex, String transformation) {
		mCurrentPage.addTextAsHex(leftPosition, topPositionFromBottom, hex, transformation);
	}
